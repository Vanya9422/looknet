 ...
 */
class FakeUserResource extends JsonResource {

    /**
     * @param $resource
     * @param int|null $advertiseID
     */
    public function __construct($resource, private ?int $advertiseID) {
    ...
    public function toArray($request): array|\JsonSerializable|\Illuminate\Contracts\Support\Arrayable {
        ...
        return [
            ...
            'rating_reviews' => $this->ratingReviews($this->advertiseID),
