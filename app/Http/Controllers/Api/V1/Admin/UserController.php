...
class UserController extends Controller {
    ...
    public function getAdvertises(
        ...
        $advertisesList = $advertiseRepository->where('user_id', $user->id)->paginate($request->query('per_page'));

        $result = AdvertiseResource::collection($advertisesList);
     ...
     * @return JsonResponse
     */
    public function deleteAccountUser(User $user): JsonResponse {
        $user->forceDelete();
