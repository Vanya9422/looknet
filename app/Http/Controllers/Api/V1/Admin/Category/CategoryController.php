...
class CategoryController extends Controller {
    ...
    public function store(CategoryRequest $request): CategoryResource|JsonResponse {
        try {
            ...
            return new CategoryResource(
                $category->load(['subCategories', 'picture', 'category'])
            );
        } catch (\Exception $e) {
            Log::error($e);
    ...
    public function update(CategoryRequest $request, Category $category): CategoryResource|JsonResponse {
        try {
            ...
            return new CategoryResource($category->load(['subCategories', 'picture', 'category']));
        } catch (\Exception $e) {
            Log::error($e);
            return $this->clientErrorResponse($e->getMessage());
        }
    ...
    public function show(Category $category): CategoryResource {
        $category->load(['subCategories', 'picture', 'category', 'filters']);
    ...
    public function duplicateCategory(Category $category): CategoryResource {
        ...
        return new CategoryResource($category->load([
            'filters.answers',
            'filters.sub_filters.answers',
            'allSubCategories.filters.sub_filters.answers',
            'allSubCategories.filters.answers',
            'picture',
        ]));
    }
