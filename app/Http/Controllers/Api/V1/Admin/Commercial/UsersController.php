...
class UsersController extends Controller {
    ...
    public function updateOrCreate(CommercialUsersRequest $request): CommercialUserResource|JsonResponse {
        try {
            ...
            return new CommercialUserResource($commercial->load(['avatar', 'group']));
        } catch (\Exception $e) {
            Log::error($e);
    ...
    /**
     * @param \App\Models\Admin\Commercial\CommercialUsers $commercialUser
     * @return JsonResponse
     */
    ...
    public function details(CommercialUsers $commercialUser): CommercialUserResource|JsonResponse {
        return new CommercialUserResource($commercialUser->load(['avatar', 'group']));
    }
}
