...
class Media extends \Spatie\MediaLibrary\MediaCollections\Models\Media implements Auditable{
    ...
    const CHAT_IMAGE_CONVERSIONS = ['small' => 150, 'medium' => 1024];

    const DEFAULT_DISC = 's3';
    const PUBLIC = 'public';

    public static array $selectedFields = [
        'id', 'model_type', 'model_id', 'disk',
        'conversions_disk', 'custom_properties',
        'file_name', 'collection_name', 'name', 'image_key'
    ];
